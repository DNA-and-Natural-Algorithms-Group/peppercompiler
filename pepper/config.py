...
# Use XDG to define the appropriate configuration location
...
def main():
  ...
  if thermo in ("", "1", "(1)",1):
    ...
    if nupack_path:
      ...
      other = input("To use a different version, enter the path [enter nothing for default above]:")
      if other:
        # TODO: Don't exit
      ...
      nupack_path = input("Please enter path to Nupack mfe:")
      # TODO: Don't exit
      assert is_nupack_mfe(nupack_path), "Bad path"

  # Vienna RNAfold
  elif thermo in ("2", "(2)",2):
    thermo = VIENNA
    ...
    if vienna_path:
      ...
      vienna_path = input("Please enter path to Vienna RNAfold:")
      # TODO: Don't exit
    ...
    if par_file:
      ...
      par_file = input("Please enter path to Vienna parameter file:")
      # TODO: Don't exit
